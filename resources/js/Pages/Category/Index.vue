            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 ">
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Categories List</h2>
                        ...
                        <div v-if="can.manage_categories">
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead>
                                        <tr>
                                            ...
                                            <th v-if="can.manage_categories" scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-0">

                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                                        <tr v-for="(category, index) in fetchedData" :key="index">
                                            ...
                                            <td v-if="can.manage_categories" class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                                <Link :href="route('categories.edit', category)" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-2">
                                                    Edit
                                                </Link>

                                                <a href="#" @click="deleteData(route('api.categories.destroy', category))" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
